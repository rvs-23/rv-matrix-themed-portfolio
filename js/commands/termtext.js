...
export default function termTextCommand(args, context) {
    ...
    if (!args || args.length === 0) {
        ...
        const currentSize = typeof getComputedStyle !== 'undefined' && document.documentElement
    ...
    if (terminalController.setTerminalFontSize) {
        ...
        appendToTerminal("<div class='output-error'>Terminal font size control not available.</div>", 'output-error-wrapper');
    }
}
