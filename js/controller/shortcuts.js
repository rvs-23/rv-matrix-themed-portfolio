...
export function initializeShortcuts(config, onCrtToggleCb) {
    ...
    konamiCodeSequence = (config && config.terminalConfig && config.terminalConfig.konamiCodeSequence) || [];
...
function globalKeydownHandler(e) {
    ...
    if (konamiCodeSequence.length > 0) {
        ...
        } else if (keyLower === konamiCodeSequence[0].toLowerCase() && konamiCodeIndex > 0) {
    ...
    if (document.activeElement === commandInputElement || document.activeElement.tagName === 'A') {
